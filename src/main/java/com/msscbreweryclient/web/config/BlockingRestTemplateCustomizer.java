package com.msscbreweryclient.web.config;
...
public class BlockingRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    public BlockingRestTemplateCustomizer(@Value("${sfg.maxtotal.connection}") Integer maxTotalConnection,
                                          ...
                                          @Value("${dfg.sockettimeout}") Integer socketTimeout) {
